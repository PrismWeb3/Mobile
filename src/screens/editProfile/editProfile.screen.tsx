...
import { Image, StyleSheet, TouchableOpacity, View, Text, TextInput, Platform } from 'react-native';
...
export function EditProfileScreen(props: Props): JSX.Element {
    ...
    return <ScrollView style={[styles.container, globalStyles.containerColorMain]} bounces={false} keyboardShouldPersistTaps={'handled'}>
        ...
        <TouchableOpacity
            ...
            onPress={editImage}
        >
            <Text style={[styles.editText, globalStyles.fontColorAccent]}>Edit</Text>
        </TouchableOpacity>

        <View style={styles.textInputContainer}>
            <Text style={[styles.label, globalStyles.fontColorSecondary]}>Username</Text>
            <TextInput
        ...
        <View style={styles.textInputContainer}>
            <Text style={[styles.label, globalStyles.fontColorSecondary]}>Name</Text>
            <TextInput
                style={[styles.textInput, globalStyles.fontColorPrimary]}
                value={name}
        ...
        <View style={styles.textInputContainer}>
            <Text style={[styles.label, globalStyles.fontColorSecondary]}>Description</Text>
            <TextInput
                style={[styles.textInput, globalStyles.fontColorPrimary]}
                value={description}
