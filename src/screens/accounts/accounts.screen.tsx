...
export function AccountsScreen(props: Props): JSX.Element {
    ...
    const checkDeSoConnection = async () => {
        const deSoConnection = await SecureStore.getItemAsync(Constants.SECURE_STORAGE_DESO_CONNECTION);
                ...
                [
                    {
                        ...
                        onPress: () => {
                            ...
                            SecureStore.deleteItemAsync(Constants.SECURE_STORAGE_DESO_CONNECTION);
                        }
                    },
                    {
                        text: 'No',
    ...
    return <View style={[styles.container, globalStyles.containerColorMain]}>
        <DefaultScreenHeader title={'Accounts'} back={true} navigation={props.navigation} />

        <TouchableOpacity
            style={styles.accountContainer}
            onPress={connectDeSo}
        >
            <Image style={styles.desoLogo} source={require('../../../assets/deso.png')} />
            <Text style={[styles.logoText, globalStyles.fontColorPrimary]}>DeSo</Text>

            {deSoConnected && renderConnected()}
            {deSoLoading && <ActivityIndicator size={'small'} color={globalStyles.fontColorSecondary.color} />}
        </TouchableOpacity>

        <TouchableOpacity style={styles.accountContainer}>
            <Image style={styles.ethLogo} source={require('../../../assets/ethereum.png')} />
            <Text style={[styles.logoText, globalStyles.fontColorPrimary]}>Ethereum</Text>
