...
export function ChatReplyMessage(props: Props): JSX.Element {
  return (
    <View style={[styles.replyContainer, props.style]}>
      <View
        style={[styles.replyLine, { backgroundColor: props.headerColor }]}
      />

      <View style={styles.textWrapper}>
        <Text style={[styles.replyUsername, { color: props.headerColor }]}>
          {props.message.isSender ? "HPaulson" : props.contact.username}
        </Text>
