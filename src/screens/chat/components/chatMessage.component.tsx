...
export function ChatMessage(props: Props): JSX.Element {
    ...
    const getMediaDimensions = (): { width: number, height: number } | undefined => {
    ...
    const renderRightCancelSwipe = (dragX: Animated.AnimatedInterpolation): JSX.Element | undefined => {
    ...
    const arrowStyles = props.message.isSender ? [styles.rightArrow, { backgroundColor: messageColor }] : [styles.leftArrow, { backgroundColor: messageColor }];
    const arrowOverlap = props.message.isSender ? [styles.rightArrowOverlap] : [styles.leftArrowOverlap];
    ...
    >
        <Swipeable
            ...
            renderRightActions=
            {
                (_progress: Animated.AnimatedInterpolation, dragX: Animated.AnimatedInterpolation) => renderRightCancelSwipe(dragX)
            }
            rightThreshold={100}
        >
            <View
            ...
            >
                {
                    ...
                    >
                        <ChatReplyMessage
                            ...
                            headerColor={props.message.isSender ? globalStyles.fontColorPrimary.color : globalStyles.fontColorAccent.color}
                        />
                    </TouchableOpacity>
                }
