...
export function ProfileScreen(props: Props): JSX.Element {
    ...
    return <ScrollView style={[styles.container, globalStyles.containerColorMain]} bounces={false}>
        <ProfileHeader profile={globals.loggedInUser as Profile} navigation={props.navigation}/>
