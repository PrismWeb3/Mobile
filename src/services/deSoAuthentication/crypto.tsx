...
export const crypto = {
  ...
  mnemonicToSeedHex,
  aesEncrypt: (counter: Buffer, key: Buffer, data: Buffer): string =>
    ecies.aesCtrEncrypt(counter, key, data),
  aesDecrypt: (counter: Buffer, key: Buffer, data: Buffer): string =>
    ecies.aesCtrDecrypt(counter, key, data),
  aesDecryptHex,
  publicKeyToECBuffer,
  compressPublicKey,
};
