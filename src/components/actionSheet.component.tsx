    ...
    return <Modal
        ...
        <View style={[styles.optionsContainer]}>
            {
                options.map(
                    (option: ActionSheetOption, index: number) =>
                        ...
                        >
                            {option.icon}
                            <Text style={[styles.optionText, globalStyles.fontColorPrimary, option.icon && styles.optionTextMargin]}>{option.text}</Text>
                        </TouchableOpacity>
                )
            }
        </View>
        ...
        <View style={[styles.cancelContainer]}>
            <TouchableOpacity
                ...
                activeOpacity={0.6}
            >
                <Text style={[styles.optionText, globalStyles.fontColorPrimary]}>Cancel</Text>
            </TouchableOpacity>
        </View>
    </Modal>;
}
